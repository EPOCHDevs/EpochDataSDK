...
Comprehensive coverage of market, corporate, economic, and alternative data for quantitative research and analysis.
...
<Cards>
  <Card
    title="Market Data"
    description="OHLCV bars, tick trades, quotes across stocks, indices, futures, crypto, forex. Multi-year intraday history."
...
|----------|----------|---------------|-------------|------------------|
| **Market Data** | OHLCV, Trades, Quotes | Stocks, Indices, Futures, Crypto, Forex | 1min to daily | Multi-year depth |
...
| **Alternative Data** | 13F, Insider, Short Interest, News | U.S. Securities | Real-time to quarterly | 10-20+ years |
...
**Market Data**
- OHLCV bars (1min to daily) for stocks, indices, futures, crypto, forex from 2004-present
