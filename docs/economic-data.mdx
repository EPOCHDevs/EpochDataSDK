...
<Cards>
  <Card title="Inflation Metrics" href="#inflation-metrics">
    CPI, Core CPI, PCE. Fed's preferred inflation measures.

    **Coverage**: 60+ years
    **Frequencies**: Monthly
  </Card>

  <Card title="Interest Rates" href="#interest-rates">
    Fed Funds, Treasury yields (3M to 30Y). Risk-free rates.

    **Coverage**: 30-60+ years
    **Frequencies**: Daily
  </Card>

  <Card title="Economic Activity" href="#economic-activity">
    GDP, industrial production, retail sales. Growth indicators.

    **Coverage**: 70+ years
    **Frequencies**: Monthly to Quarterly
  </Card>

  <Card title="Labor Market" href="#labor-market">
    Unemployment, jobless claims, payrolls. Employment metrics.

    **Coverage**: 70+ years
    **Frequencies**: Weekly to Monthly
  </Card>

  <Card title="Market Indicators" href="#market-indicators">
    S&P 500, VIX. Equity and volatility benchmarks.
