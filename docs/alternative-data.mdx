...
<Cards>
  <Card title="Institutional Holdings (13F)" href="#institutional-holdings-form-13f">
    Quarterly filings from $100M+ managers. Track elite fund positions.

    **Coverage**: 10+ years
    **Frequencies**: Quarterly (45-day filing lag)
  </Card>

  <Card title="Insider Trading" href="#insider-trading">
    Officer, director, and major shareholder transactions. Sentiment signals.

    **Coverage**: 20+ years
    **Frequencies**: Event-driven (2-day lag)
  </Card>

  <Card title="Short Interest" href="#short-interest">
    Daily short volume and bi-weekly settlement data. Crowding detection.

    **Coverage**: Multi-year
    **Frequencies**: Daily and bi-weekly
  </Card>

  <Card title="Financial News" href="#financial-news">
    Corporate news and press releases. Event detection and sentiment.
