...
|---------|------------------|----------|--------------|
| **Institutional Holdings (13F)** | Quarterly (45-day filing lag) | 10+ years | Quarterly filings from $100M+ managers. Track elite fund positions. |
| **Insider Trading** | Event-driven (2-day lag) | 20+ years | Officer, director, and major shareholder transactions. Sentiment signals. |
...
<Callout type="warning" title="Disclosure Timing">
...
<Callout type="tip" title="Critical Date Field">
...
<Callout type="tip" title="Insider Buying Signal">
