...
Fundamental company data - financial statements, dividends, splits, and IPO information. Indexed by filing dates for research accuracy.

<Callout type="info" title="Data Access Only">
Epoch provides access to corporate financial data for research and analysis purposes. This is not investment advice.
</Callout>
...
|---------|------------------|----------|--------------|
| **Financial Statements** | Quarterly (10-Q), Annual (10-K) | 10+ years | Income statement, balance sheet, cash flow |
| **Dividends** | Event-driven | 10+ years | Cash and stock distributions for total return calculations |
| **Stock Splits** | Event-driven | Complete history | Forward and reverse splits for price adjustment |
| **IPO Data** | Event-driven | 10+ years | New listings, pricing, offering details |
...
| **Dividends** | Event-driven | U.S. stocks | Income analysis, total return calculations |
| **Stock Splits** | Event-driven | U.S. stocks | Price adjustment, corporate action analysis |
| **IPO Data** | Event-driven | New listings | IPO research, calendar tracking |
...
<Callout type="warning" title="Lookahead Bias Prevention">
...
<Callout type="tip" title="Total Returns">
...
- **IPO Research**: Track calendar, study first-day movements, analyze pricing vs. range, identify over/under-subscribed deals
- **New Issue Analysis**: Compare offering sizes, track market cycles (hot vs. cold), analyze industry clusters
...
- [Market Data](/docs/market-data) - Combine fundamentals with price action
- [Economic Data](/docs/economic-data) - Add macro context to fundamental analysis
- [Alternative Data](/docs/alternative-data) - Validate fundamental story with smart money moves
