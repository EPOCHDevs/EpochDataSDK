...
<Cards>
  <Card title="Financial Statements" href="#financial-statements">
  ...
  <Card title="Dividends" href="#dividends">
    Cash and stock distributions. Critical for total return calculations.

    **Coverage**: 10+ years
    **Frequencies**: Event-driven
  </Card>

  <Card title="Stock Splits" href="#stock-splits">
    Forward and reverse splits. Required for price adjustment.

    **Coverage**: Complete history
    **Frequencies**: Event-driven
  </Card>

  <Card title="IPO Data" href="#ipo-data">
    New listings, pricing, offering details. Calendar tracking.
