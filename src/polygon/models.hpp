...
struct CashFlowData {
  ...
  std::optional<double> effect_of_currency_exchange_rate;
  std::optional<std::string> filing_date;
  std::optional<std::int64_t> fiscal_quarter;
  std::optional<std::int64_t> fiscal_year;
  std::optional<double> income_loss_from_discontinued_operations;
  ...
  std::optional<double> net_cash_from_financing_activities_discontinued_operations;
  ...
  std::optional<double> net_cash_from_investing_activities_discontinued_operations;
  std::optional<double> net_cash_from_operating_activities;
  std::optional<double> net_cash_from_operating_activities_discontinued_operations;
  std::optional<double> net_income;
  std::optional<double> noncontrolling_interests;
  std::optional<double> other_cash_adjustments;
  ...
  std::optional<double> sale_of_property_plant_and_equipment;
