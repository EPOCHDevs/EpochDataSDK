...
// Convenience macro
#define ENV(key) data_sdk::EnvLoader::instance().get(key)
#define ENV_INT(key) data_sdk::EnvLoader::instance().getInt(key)
#define ENV_BOOL(key) data_sdk::EnvLoader::instance().getBool(key)
